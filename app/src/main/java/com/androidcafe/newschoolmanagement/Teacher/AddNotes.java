...
public class AddNotes extends AppCompatActivity implements UploadFile.OnImageUpload, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_division.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter class_adapter = new ArrayAdapter(AddNotes.this,android.R.layout.simple_list_item_1,common.classlist(student_division.getSelectedItemPosition()));
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isselected||common.isEmpty(title)||common.isEmpty(description)||student_division.getSelectedItemPosition()==0||student_medium.getSelectedItemPosition()==0||student_class.getSelectedItemPosition()==0||student_subject.getSelectedItemPosition()==0) {
                    if (!isselected) {
                        Toast.makeText(AddNotes.this, "Please attach file", Toast.LENGTH_SHORT).show();
                    }


                    if (common.isEmpty(title))
                    {
                        title.setError("Enter topic name");
                    }
                ...
                {
                uploadFile.uploadonfirestorage(saveUri,AddNotes.this);
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode,  Intent data) {
        ...
        if (PDF_REQUEST==requestCode&&resultCode==RESULT_OK)
        {
            ...
            Bitmap bitmap = null;
            try {
                bitmap = MediaStore.Images.Media.getBitmap(AddNotes.this.getContentResolver(),data.getData());
    ...
    public void getUrl(String url) {
            uploadDataOnFireStore.addNotes(student_medium.getSelectedItem().toString(),student_class.getSelectedItem().toString(),student_subject.getSelectedItem().toString(),title.getText().toString(),description.getText().toString(),url,AddNotes.this);
    }
